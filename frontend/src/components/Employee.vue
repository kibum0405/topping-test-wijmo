<template>
    ...
    <v-card style="width:450px;" outlined>
        ...
        <Boolean label="IsManager" v-model="value.isManager" :editMode="editMode"/>
            <PositionId offline label="PositionId" v-model="value.positionId" :editMode="editMode" @change="change"/>
...
<script>
    ...
    import PositionBase from '../components/PositionBase.vue'
    ...
    export default {
        ...
        methods: {
            async init() {
                ...
                let PositionClass = Vue.extend(PositionBase);
                me.positionId = new PositionClass();
                ...
                let Promises = lists.map(async function (value) {
                    value.positionId = await me.positionId.positionIdToName(value.positionId.id);
                    value.rankId = await me.rankId.rankIdToName(value.rankId.id);
                    value.departmentId = await me.departmentId.departmentIdToName(value.departmentId.id);
                });
