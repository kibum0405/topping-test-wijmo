<template>
    <div class="container-fluid">
        <PositionViewQuery @search="search"></PositionViewQuery>
        <div class="row">
            <!-- export to Excel -->
        ...
        >
            <wj-flex-grid-filter :filterColumns="['Id','UserName','UserId','DepartmentId',]" />
            ...
            <wj-flex-grid-column binding="departmentId.department" header="DepartmentId" width="2*" :isReadOnly="true" />
        </wj-flex-grid>
...
<script>
import PositionViewQuery from '../components/PositionViewQuery.vue';
